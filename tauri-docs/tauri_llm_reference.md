...
Generated: 2025-09-01T04:17:11.630536
Total concepts: 28
Total commands: 135
Total workflows: 16
...
- **windows**: Capabilities for Different Windows and Platforms, Configuration Files, Core Permissions, Create a Project, Debug in VS Code
- **macos**: Capabilities for Different Windows and Platforms, Configuration Files, Create a Project, Develop, Environment Variables
- **linux**: Capabilities for Different Windows and Platforms, Configuration Files, Create a Project, Develop, Environment Variables
- **android**: Capabilities for Different Windows and Platforms, Configuration Files, Develop, Environment Variables, App Icons
- **ios**: Calling Rust from the Frontend, Capabilities for Different Windows and Platforms, Configuration Files, Develop, Environment Variables
- **cross_platform**: Calling the Frontend from Rust, Calling the Frontend from Rust, Project Structure, State Management, System Tray

## Learning Path
- **Beginner**: Configuration Files, Create a Project, Debug in VS Code, Calling the Frontend from Rust, Updating Dependencies
- **Intermediate**: Calling the Frontend from Rust, Calling Rust from the Frontend, Capabilities for Different Windows and Platforms, Core Permissions, Develop
- **Advanced**: Upgrade from Tauri 1.0, Splashscreen, State Management, Using Plugin Permissions
...
- **platform specific**: windows, macos, linux, android, ios
