...
export function LiveFFPlayPanel({ onBack }: LiveFFPlayPanelProps) {
  ...
  const preview = useAutoPreview(timeline, [timeline?.globalTempo, timeline?.noCutZones]);

  const handleCreateRequest = useCallback(async (request: CreateRequest) => {
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                ...
                {selectedClipPaths.length > 0 && (
                  <Card>
                    <CardHeader>
                      <CardTitle className="text-sm">Selected Clips ({selectedClipPaths.length})</CardTitle>
                    </CardHeader>
                    <CardContent>
              ...
              <div className="space-y-4">
                <Card>
                  ...
                  <CardContent className="text-sm space-y-3">
                    <div>
                      <strong>1. Select Audio:</strong> Choose an audio file for beat analysis.
                    </div>
                    <div>
                      <strong>2. Choose Duration:</strong> Set how much of the audio to analyze.
                    </div>
                    <div>
                      <strong>3. Video Length:</strong> Set the target length for your video.
                    </div>
                    <div>
                      <strong>4. Clip Order:</strong> Random or alphabetical arrangement.
                    </div>
                    <div>
                      <strong>5. Create:</strong> Generate timeline and start instant preview!
                    </div>
                  </CardContent>
                </Card>
            ...
            <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
              ...
              <div className="space-y-4">
                <Card>
                  ...
                  <CardContent className="text-sm space-y-3">
                    <div>
                      <strong>Clips:</strong> {timeline.clips.length} video segments
                    </div>
                    <div>
                      <strong>FPS:</strong> {timeline.fps} frames per second
                    </div>
                    <div>
                      <strong>Tempo:</strong> {timeline.globalTempo.toFixed(1)}x speed
                    </div>
                    <div>
                ...
                <Card>
                  ...
                  <CardContent className="text-sm space-y-3">
                    <div>
                      <strong>External Preview:</strong> Opens FFplay window for real-time preview
                    </div>
                    <div>
                      <strong>Embedded Player:</strong> Watch rendered MP4 in the app
                    </div>
                    <div>
                      <strong>Tempo Control:</strong> Adjust speed and regenerate
                    </div>
                    <div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                <Card>
                  ...
                  <CardContent className="text-sm space-y-3">
                    <div>
                      Timeline created with {timeline.clips.length} clips.
                      Preview will start automatically when you click Preview.
                    </div>
                    <div>
                      <strong>Tempo Control:</strong> Adjust playback speed and effect intensity.
                    </div>
                    <div>
                      <strong>Real-time Updates:</strong> Changes restart preview with 350ms debounce.
                    </div>
                  </CardContent>
                </Card>
