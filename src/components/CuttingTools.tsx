...
export const CuttingTools = () => {
  ...
  const cutAtPlayhead = () => {
    ...
    const clipAtPlayhead = timeline.find(item => 
  ...
  const autoCutToBeats = () => {
    timeline.forEach(item => {
      ...
      const beatsInClip = mockBeats.filter(beat => 
      ...
      <CardContent className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          {razorMode && (
            <div className="text-xs text-blue-400 bg-blue-900/20 p-2 rounded">
              🔪 Razor mode active - Click on timeline clips to cut them at the playhead
            </div>
          )}
        </div>
        ...
        <div className="space-y-3">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(e) => setAutoCutTolerance(parseFloat(e.target.value) || 0.1)}
              className="h-8"
              min="0.1"
              max="2"
              step="0.1"
        ...
        <div className="space-y-3">
          ...
          <div className="text-xs text-muted-foreground">
            Next beat: {mockBeats.find(beat => beat > playhead)?.toFixed(1) || 'N/A'}s
          </div>
